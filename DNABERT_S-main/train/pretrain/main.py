...
def run(args):
    ...
    #tokenizer = AutoTokenizer.from_pretrained("/home/zhaozhimiao/csm/DNABERT-S", trust_remote_code=True)
    #tokenizer = AutoTokenizer.from_pretrained("/fs1/private/user/wangjingyuan/lyf/DCVBin_project/DNABERT-S", trust_remote_code=True, local_files_only=True)
    tokenizer = AutoTokenizer.from_pretrained("pretrained_models/dnabert-s", trust_remote_code=True, local_files_only=True)
