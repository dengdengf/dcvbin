...
class DNABert_S(nn.Module):
    def __init__(self, feat_dim=128, mix=True, model_mix_dict=None, load_dict=None, curriculum=False):
        ...
        if (not mix) & (not curriculum):
            self.dnabert2 = AutoModel.from_pretrained("/home/zhaozhimiao/csm/DNABERT-S", trust_remote_code=True)
        else:
            self.dnabert2 = BertModel.from_pretrained("/home/zhaozhimiao/csm/DNABERT-S")
        self.emb_size = self.dnabert2.pooler.dense.out_features # DNABERT2隐藏层维度
